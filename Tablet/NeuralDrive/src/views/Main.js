      ...
      <MainModules.FlexContainer>
        ...
        <MainModules.FlexContainer flex={0.3}>
          <MainModules.FlexContainer flexDirection='column'>
            <Buttons.RoundedButton title="Old Data" onPress={()=>blank()} bgColor={ColorTheme.Fruity.First}></Buttons.RoundedButton>
            <MainModules.InputModule height='80%' width='100%' bgColor='#555' title='test'/>
            <Buttons.RoundedButton title="" onPress={()=>blank()} bgColor={ColorTheme.Fruity.First}></Buttons.RoundedButton>
          </MainModules.FlexContainer>
        </MainModules.FlexContainer>

        <MainModules.FlexContainer flexDirection='column'>
          <MainModules.GraphModule height='95%' width='100%' bgColor='#555' title='Graph'/>
          <MainModules.FlexContainer>
